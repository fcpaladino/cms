...
class multimarcasfotosControle extends Controle {

    public function __construct(){

        // Configurações do componente
        $this->config = new stdClass();
        $this->config->componenteNome				= "Multimarcas Fotos";
        $this->config->componenteUrl				= BASE . 'multimarcas-fotos';
        $this->config->componenteTitulo				= $this->config->componenteNome;
        $this->config->componenteSubTitulo			= '';
        $this->config->componenteTabela     		= Sistema::Table("veiculos_multimarcas_fotos");
        $this->config->componenteTabelaItemPai		= Sistema::Table("veiculos_multimarcas");
        $this->config->componenteUrlItemPai			= BASE . 'multimarcas';
        $this->config->pastaImagens                 = 'multimarcas';
        ...
        // Valida o item pai
        $_t = self::item_pai($this->config->idpai, 'resumo');
