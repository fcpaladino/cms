...
class veiculosnovosfotosControle extends Controle {

	public function __construct(){

		// Configurações do componente
		$this->config = new stdClass();
		$this->config->componenteNome				= "Veículos Novos Fotos";
		$this->config->componenteUrl				= BASE . 'veiculos-novos-fotos';
		$this->config->componenteTitulo				= $this->config->componenteNome;
		$this->config->componenteSubTitulo			= '';
		$this->config->componenteTabela     		= Sistema::Table("veiculos_novos_fotos");
        $this->config->componenteTabelaItemPai		= Sistema::Table("veiculos_novos");
        $this->config->componenteUrlItemPai			= BASE . 'veiculos_novos';
        $this->config->pastaImagens                 = 'veiculos-novos';
