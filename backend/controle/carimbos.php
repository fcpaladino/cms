...
class carimbosControle extends Controle {

    public function __construct(){

        // Configurações do componente
        $this->config = new stdClass();
        $this->config->componenteNome				= "Carimbos";
        $this->config->componenteUrl				= BASE . 'carimbos';
        $this->config->componenteTitulo				= $this->config->componenteNome;
        $this->config->componenteSubTitulo			= '';
        $this->config->componenteTabela				= Sistema::Table("carimbos");
        ...
        $this->config->campos = array('nome', 'resumo', 'arquivo');
