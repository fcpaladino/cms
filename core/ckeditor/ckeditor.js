...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, e = {timestamp: "E8PB", version: "4.4.5", revision: "25cdcad", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: [], basePathSrcPattern: a}, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
        ...
        return{define: function (c, f) {
            ...
            function m(a, p, u, e) {
                a = {name: c, sender: this, editor: a, data: p, listenerData: b, stop: u, cancel: e, removeListener: j};
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, e = function (a, f) {
            ...
            return d
        }, b = {}, c = {}, f = {address: 1, article: 1, aside: 1, blockquote: 1, details: 1, div: 1, dl: 1, fieldset: 1, figure: 1, footer: 1, form: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, header: 1, hgroup: 1, hr: 1, menu: 1, nav: 1, ol: 1, p: 1, pre: 1, section: 1, table: 1, ul: 1}, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, g = {}, h = {"#": 1}, m = {center: 1, dir: 1, noframes: 1};
    ...
    (function () {
                    ...
                    for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body", l, q = d.length; q > 0;) {
                        ...
                        if (e && (o.type == CKEDITOR.NODE_TEXT || o.type == CKEDITOR.NODE_ELEMENT && N.$inline[o.name])) {
                            ...
                            l =
                                null;
                            o.insertAfter(a);
                            f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (o.type == CKEDITOR.NODE_ELEMENT && !N[f.name][o.name]) && c.push({check: "el-up", el: o})
                        }
                    }
                    a.remove()
                }
        ...
        CKEDITOR.filter.prototype = {allow: function (b, c, f) {
            ...
            check: function (a, b, c) {
                ...
                if (typeof a == "string") {
                    ...
                    f = {name: d.element, attributes: i, classes: i["class"] ? i["class"].split(/\s+/) : [], styles: f, children: []}
                }
        ...
        var v = {styles: 1, attributes: 1, classes: 1}, z = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"}, B = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, D = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, G = /^cke:(object|embed|param)$/, aa = /^(object|embed|param)$/, ba = CKEDITOR.filter.transformationsTools = {sizeToStyle: function (a) {
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return{load: function (b, c, f, d) {
            ...
            queue: function () {
                ...
                return function (f, d) {
                    var e = this;
                    c.push({scriptUrl: f, callback: function () {
    ...
    (function () {
        ...
        a.prototype = {add: function (a, c, f) {
            ...
            for (var d = [this.findIndex(c), 0], e = 0, h = a.length; e < h; e++)d.push({value: a[e], priority: c, options: f});
    ...
    (function () {
        ...
        {toHtml: function (a, b, c, d) {
            ...
            return f.fire("toHtml", {dataValue: a, context: e, fixForBody: c, dontFilter: d, filter: i || f.filter, enterMode: l || f.enterMode}).dataValue
        ...
        var o = /(?:&nbsp;|\xa0)$/, r = "{cke_protected}", i = CKEDITOR.dtd, k = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], l = CKEDITOR.tools.extend({}, i.$blockLimit, i.$block), q = {elements: {input: h, textarea: h}}, x = {attributeNames: [
            [/^on/, "data-cke-pa-on"],
            [/^data-cke-expando$/, ""]
        ]}, s = {elements: {embed: function (a) {
            var b = a.parent;
            if (b && b.name == "object") {
            ...
            }, input: m, textarea: m}, attributes: {"class": function (a) {
    ...
    (function () {
        ...
        function d(a) {
            ...
            var d, e = a.getRanges()[0], a = a.root, f = {table: 1, ul: 1, ol: 1,
                dl: 1};
        ...
        var n = function () {
            ...
            var h = CKEDITOR.dtd, s = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, j = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, p = CKEDITOR.tools.extend({}, h.$inline);
            delete p.br;
            return function (s, n, u) {
                ...
                if (!A.checkReadOnly()) {
                    var v = (new CKEDITOR.dom.elementPath(A.startContainer, A.root)).blockLimit || A.root, n = {type: n, dontFilter: E, editable: s, editor: t, range: A, blockLimit: v, mergeCandidates: [], zombies: []}, t = n.range, E = n.mergeCandidates, z, B, D, G;
    ...
    (function () {
        ...
        var x = {address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1}, s =
        {a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1}, M = /\s*(?:;\s*|$)/, R = /#\((.+?)\)/g, N = CKEDITOR.dom.walker.bookmark(0, 1), F = CKEDITOR.dom.walker.whitespaces(1);
        ...
        CKEDITOR.dialog.prototype = {destroy: function () {
            ...
            if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                for (var b = [], c = a.label ? ' title="' + CKEDITOR.tools.htmlEncode(a.label) + '"' : "", e = CKEDITOR.dialog._.uiElementBuilders.vbox.build(this,
                    {type: "vbox", className: "cke_dialog_page_contents", children: a.elements, expand: !!a.expand, padding: a.padding, style: a.style || "width: 100%;"}, b), d = this._.contents[a.id] = {}, g = e.getChild(), f = 0; e = g.shift();)!e.notAllowed && ("hbox" != e.type && "vbox" != e.type) && f++, d[e.id] = e, "function" == typeof e.getChild && g.push.apply(g, e.getChild());
                f || (a.hidden = !0);
    ...
    CKEDITOR.plugins.add("colorbutton", {requires: "panelbutton,floatpanel", init: function (c) {
        function o(m, g, d, h) {
            ...
            c.ui.add(m, CKEDITOR.UI_PANELBUTTON, {label: d, title: d, modes: {wysiwyg: 1}, editorFocus: 0, toolbar: "colors," + h, allowedContent: i, requiredContent: i, panel: {css: CKEDITOR.skin.getPath("editor"), attributes: {role: "listbox", "aria-label": f.panelTitle}}, onBlock: function (a, b) {
                b.autoSize = !0;
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("enterkey", {init: function (b) {
            b.addCommand("enter", {modes: {wysiwyg: 1}, editorFocus: !1, exec: function (b) {
                m(b)
            }});
            b.addCommand("shiftEnter", {modes: {wysiwyg: 1}, editorFocus: !1, exec: function (b) {
        ...
        CKEDITOR.plugins.enterkey = {enterBlock: function (b, d, a, h) {
            if (a = a || r(b)) {
    ...
    (function () {
        function e(b, a, e, h, j, n, l, o) {
            ...
            b.ui.addRichCombo(a, {label: h.label, title: h.panelTitle, toolbar: "styles," + o, allowedContent: k, requiredContent: k, panel: {css: [CKEDITOR.skin.getPath("editor")].concat(p.contentsCss), multiSelect: !1, attributes: {"aria-label": h.panelTitle}},
                init: function () {
    ...
    CKEDITOR.plugins.add("forms", {requires: "dialog,fakeobjects", onLoad: function () {
        ...
        var b = a.lang, g = 0, h = {email: 1, password: 1, search: 1, tel: 1, text: 1, url: 1}, j = {checkbox: "input[type,name,checked]",
            radio: "input[type,name,checked]", textfield: "input[type,name,value,size,maxlength]", textarea: "textarea[cols,rows,name]", select: "select[name,size,multiple]; option[value,selected]", button: "input[type,name,value]", form: "form[action,name,id,enctype,target,method]", hiddenfield: "input[type,name,value]", imagebutton: "input[type,alt,src]{width,height,border,border-width,border-style,margin,float}"}, k = {checkbox: "input", radio: "input", textfield: "input", textarea: "textarea", select: "select", button: "input", form: "form",
            hiddenfield: "input", imagebutton: "input"}, e = function (d, c, e) {
        ...
        CKEDITOR.env.ie && g && g.addRules({elements: {input: function (a) {
            var a = a.attributes,
                b = a.type;
            b || (a.type = "text");
    ...
    (function () {
        CKEDITOR.plugins.add("language", {requires: "menubutton", init: function (a) {
            ...
            for (f = 0; f < b.length; f++)g = b[f].split(":"), h = g[0], i = "language_" + h, e[i] = {label: g[1], langId: h, group: "language", order: f, ltr: "rtl" != ("" + g[2]).toLowerCase(), onClick: function () {
                a.execCommand("language", this.langId)
            }, role: "menuitemcheckbox"}, e[i].style = new CKEDITOR.style({element: "span", attributes: {lang: h, dir: e[i].ltr ? "ltr" : "rtl"}});
    ...
    (function () {
        ...
        function ha(a) {
            ...
            q(d, {attach: function () {
                ...
                "border-width:8px 8px 0 0;top:-8px", "border-width:0 8px 8px 0;top:0px"]})], detach: function () {
    ...
    (function () {
        var i = {readOnly: 1, preserveState: !0, editorFocus: !1, exec: function (a) {
            this.toggleState();
            this.refresh(a)
        }, refresh: function (a) {
            if (a.document) {
    ...
    CKEDITOR.plugins.add("table", {requires: "dialog", init: function (a) {
        function e(a) {
            return CKEDITOR.tools.extend(a || {}, {contextSensitive: 1, refresh: function (a, f) {
        ...
        if (!a.blockless) {
            ...
            a.addCommand("tableDelete", e({exec: function (a) {
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("undo", {init: function (a) {
            ...
            var d = a.undoManager = new e(a), j = d.editingHandler = new i(d), f = a.addCommand("undo", {exec: function () {
        ...
        i.prototype = {onKeydown: function (a) {
